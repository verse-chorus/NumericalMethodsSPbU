## МНК
1) Аналитическое решение МНК через нормальные уравнения. Вычисление ошибки аппроксимации полиномами разной степени
3) Построение ортогональных полиномов
4) Сравнение двух выше указанных подходов
## Интерполяция
...
## Решение задачи Коши для систем ОДУ методом Рунге-Кутты
### Методы решения
